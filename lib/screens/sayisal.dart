                    ...
                    onPressed: () {
                      if (bakiye <= 0) {
                        ...
                        setState(() {
                          ...
                          bakiye -= 5;
                          sistemKontrol();
                          sistem[0].toString() == sayi1Controller.text
                              ? cevap += 1
                              : null;
                          sistem[1].toString() == sayi2Controller.text
                              ? cevap += 1
                              : null;
                          sistem[2].toString() == sayi3Controller.text
                              ? cevap += 1
                              : null;
                          sistem[3].toString() == sayi4Controller.text
                              ? cevap += 1
                              : null;
                          sistem[4].toString() == sayi5Controller.text
                              ? cevap += 1
                              : null;
                          sistem[5].toString() == sayi6Controller.text
                              ? cevap += 1
                              : null;
                          odulSistemi();
                          showDialog(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: cevap != 0
                                                ? Text(
                                                    "Kazanılan Paranız :$kazanilanPara",
